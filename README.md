## Promises (Домашнее задание к лекции «Promises, async/await») [![Build status](https://ci.appveyor.com/api/projects/status/rfnwllc08abwwrdc?svg=true)](https://ci.appveyor.com/project/bas27/fpyajs-promise)
